...
describe('Service Tests', () => {
  describe('Resource Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Resource(123, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Resource', async () => {
        const returnedFromService = { name: 'BBBBBB', resourceType: 'BBBBBB', status: 'BBBBBB', ...elemDefault };
      ...
      it('should partial update a Resource', async () => {
        const patchObject = { status: 'BBBBBB', ...new Resource() };
