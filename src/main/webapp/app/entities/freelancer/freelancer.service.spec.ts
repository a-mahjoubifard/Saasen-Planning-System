...
describe('Service Tests', () => {
  describe('Freelancer Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Freelancer(123, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Freelancer', async () => {
        const returnedFromService = { name: 'BBBBBB', contact: 'BBBBBB', qualification: 'BBBBBB', ...elemDefault };
      ...
      it('should partial update a Freelancer', async () => {
        const patchObject = { qualification: 'BBBBBB', ...new Freelancer() };
