...
/**
 * REST controller for managing {@link com.saasen.nl.domain.Customer}.
 */
@RestController
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                updateIfPresent(existingCustomer::setName, customer.getName());
                updateIfPresent(existingCustomer::setContactInfo, customer.getContactInfo());
