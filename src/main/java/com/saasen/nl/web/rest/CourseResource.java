...
/**
 * REST controller for managing {@link com.saasen.nl.domain.Course}.
 */
@RestController
...
public class CourseResource {
    ...
    public ResponseEntity<Course> partialUpdateCourse(
        ...
        Optional<Course> result = courseRepository
            ...
            .map(existingCourse -> {
                updateIfPresent(existingCourse::setTitle, course.getTitle());
                updateIfPresent(existingCourse::setDuration, course.getDuration());
