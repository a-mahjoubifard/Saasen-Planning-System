...
import com.saasen.nl.repository.LocationRepository;
...
/**
 * REST controller for managing {@link com.saasen.nl.domain.Location}.
 */
@RestController
    ...
    public ResponseEntity<Location> partialUpdateLocation(
        ...
        Optional<Location> result = locationRepository
            ...
            .map(existingLocation -> {
                updateIfPresent(existingLocation::setName, location.getName());
                updateIfPresent(existingLocation::setAddress, location.getAddress());
                updateIfPresent(existingLocation::setCapacity, location.getCapacity());
                updateIfPresent(existingLocation::setEquipmentType, location.getEquipmentType());
