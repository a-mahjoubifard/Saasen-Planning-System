...
import static com.saasen.nl.domain.ResourceAsserts.*;
...
import com.saasen.nl.domain.Resource;
import com.saasen.nl.repository.ResourceRepository;
...
class ResourceResourceIT {
    ...
    public static Resource createEntity() {
        return new Resource().name(DEFAULT_NAME).resourceType(DEFAULT_RESOURCE_TYPE).status(DEFAULT_STATUS);
    }
    ...
    public static Resource createUpdatedEntity() {
        return new Resource().name(UPDATED_NAME).resourceType(UPDATED_RESOURCE_TYPE).status(UPDATED_STATUS);
    }
    ...
    void putExistingResource() throws Exception {
        ...
        updatedResource.name(UPDATED_NAME).resourceType(UPDATED_RESOURCE_TYPE).status(UPDATED_STATUS);
    ...
    void fullUpdateResourceWithPatch() throws Exception {
        ...
        partialUpdatedResource.name(UPDATED_NAME).resourceType(UPDATED_RESOURCE_TYPE).status(UPDATED_STATUS);
