...
import static com.saasen.nl.domain.CustomerAsserts.*;
...
import com.saasen.nl.domain.Customer;
import com.saasen.nl.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity() {
        return new Customer().name(DEFAULT_NAME).contactInfo(DEFAULT_CONTACT_INFO);
    }
    ...
    public static Customer createUpdatedEntity() {
        return new Customer().name(UPDATED_NAME).contactInfo(UPDATED_CONTACT_INFO);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).contactInfo(UPDATED_CONTACT_INFO);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).contactInfo(UPDATED_CONTACT_INFO);
