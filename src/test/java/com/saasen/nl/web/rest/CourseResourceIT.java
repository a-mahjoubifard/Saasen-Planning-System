...
import static com.saasen.nl.domain.CourseAsserts.*;
...
import com.saasen.nl.repository.CourseRepository;
...
class CourseResourceIT {
    ...
    public static Course createEntity() {
        return new Course().title(DEFAULT_TITLE).duration(DEFAULT_DURATION);
    }
    ...
    public static Course createUpdatedEntity() {
        return new Course().title(UPDATED_TITLE).duration(UPDATED_DURATION);
    }
    ...
    void putExistingCourse() throws Exception {
        ...
        updatedCourse.title(UPDATED_TITLE).duration(UPDATED_DURATION);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.duration(UPDATED_DURATION);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.title(UPDATED_TITLE).duration(UPDATED_DURATION);
