...
import static com.saasen.nl.domain.LocationAsserts.*;
...
class LocationResourceIT {
    ...
    public static Location createEntity() {
        return new Location().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).capacity(DEFAULT_CAPACITY).equipmentType(DEFAULT_EQUIPMENT_TYPE);
    }
    ...
    public static Location createUpdatedEntity() {
        return new Location().name(UPDATED_NAME).address(UPDATED_ADDRESS).capacity(UPDATED_CAPACITY).equipmentType(UPDATED_EQUIPMENT_TYPE);
    }
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].equipmentType").value(hasItem(DEFAULT_EQUIPMENT_TYPE)));
    }
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.equipmentType").value(DEFAULT_EQUIPMENT_TYPE));
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.name(UPDATED_NAME).address(UPDATED_ADDRESS).capacity(UPDATED_CAPACITY).equipmentType(UPDATED_EQUIPMENT_TYPE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.address(UPDATED_ADDRESS).capacity(UPDATED_CAPACITY).equipmentType(UPDATED_EQUIPMENT_TYPE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).address(UPDATED_ADDRESS).capacity(UPDATED_CAPACITY).equipmentType(UPDATED_EQUIPMENT_TYPE);
